...
namespace Ical.Net.Utility
{
    ...
    {
        public static IDateTime StartOfDay(this IDateTime dt)
            => dt.AddHours(-dt.Hour).AddMinutes(-dt.Minute).AddSeconds(-dt.Second);

        public static IDateTime EndOfDay(this IDateTime dt)
            => StartOfDay(dt).AddDays(1).AddTicks(-1);

        public static DateTime GetSimpleDateTimeData(this IDateTime dt)
            => DateTime.SpecifyKind(dt.Value, dt.IsUtc ? DateTimeKind.Utc : DateTimeKind.Local);

        public static DateTime SimpleDateTimeToMatch(this IDateTime dt, IDateTime toMatch)
        {
        ...
        public static IDateTime MatchTimeZone(this IDateTime dt1, IDateTime dt2)
        {
        ...
        public static DateTime AddWeeks(this DateTime dt, int interval, DayOfWeek firstDayOfWeek)
        {
        ...
        public static DateTime FirstDayOfWeek(this DateTime dt, DayOfWeek firstDayOfWeek, out int offset)
        {
            offset = 0;
            while (dt.DayOfWeek != firstDayOfWeek)
            {
        ...
        /// <summary> Use this method to turn a raw string into a NodaTime DateTimeZone. </summary>
        /// <remarks>
        /// It searches all time zone providers (IANA, BCL, serialization, etc) to see if the string matches.
        /// If it doesn't, it walks each provider,
        /// and checks to see if the time zone the provider knows about
        /// is contained within the target time zone string.
        ///
        /// Some older icalendar programs would generate nonstandard time zone strings,
        /// and this secondary check works around that.
        /// </remarks>
        ...
        public static ZonedDateTime AddYears(this ZonedDateTime zonedDateTime, int years)
        {
        ...
        public static ZonedDateTime AddMonths(this ZonedDateTime zonedDateTime, int months)
        {
        ...
        public static ZonedDateTime ToZonedDateTimeLeniently(this DateTime dateTime, string tzId)
        {
        ...
        public static ZonedDateTime FromTimeZoneToTimeZone(this DateTime dateTime, string fromZoneId, string toZoneId)
            => FromTimeZoneToTimeZone(dateTime, GetZone(fromZoneId), GetZone(toZoneId));

        public static ZonedDateTime FromTimeZoneToTimeZone(this DateTime dateTime, DateTimeZone fromZone, DateTimeZone toZone)
        {
        ...
        /// <remarks>
        /// For example, to truncate to the nearest second, use TimeSpan.FromSeconds(1)
        /// 
        /// </remarks>
