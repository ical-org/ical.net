...
{
    /// <summary>
    /// The assembly file version of the ical.net library.
    /// </summary>
    internal static readonly string AssemblyFileVersion = GetAssemblyVersion();
    ...
    /// </remarks>
    /// </summary>
    public static string ProdId => $"-//github.com/ical-org/ical.net//NONSGML ical.net {AssemblyFileVersion}//EN";
