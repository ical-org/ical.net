...
using DDay.iCal.Serialization.xCal.DataTypes;

namespace DDay.iCal.Serialization.xCal
{
    /// <summary>
    /// A class that generates serialization objects for xCal serialization
    /// for iCalendar components.
    /// </summary>
    public class SerializerFactory
    {
        static public IXCalSerializable Create(object obj)
        {
            if (obj != null)
            {
                ...
                if (type.IsArray)
                    ...
                    return new xCalSerializer(obj as DDay.iCal.iCalendar);
