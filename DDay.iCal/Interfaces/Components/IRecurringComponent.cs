...
namespace DDay.iCal
{
        ...
        IUniqueComponent
    {
        ...
        List<Occurrence> GetOccurrences(iCalDateTime startTime, iCalDateTime endTime);
        ...
        List<AlarmOccurrence> PollAlarms();
        ...
        List<AlarmOccurrence> PollAlarms(iCalDateTime Start, iCalDateTime End);
    }
}
