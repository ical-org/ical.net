...
namespace DDay.iCal
{
        ...
        ITimeZone
    {
        ...
        static private void PopulateiCalTimeZoneInfo(TimeZoneInfo tzi, System.TimeZoneInfo.TransitionTime transition, int year)
        {
            Calendar c = CultureInfo.CurrentCulture.Calendar;

            IRecurrencePattern recurrence = new RecurrencePattern();
        ...
        public static iCalTimeZone FromSystemTimeZone(System.TimeZoneInfo tzinfo)
        {
            ...
            {                
                ...
                var dday_tzinfo_standard = new DDay.iCal.TimeZoneInfo();
                ...
                dday_tzinfo_standard.TZOffsetFrom = new DDay.iCal.UTCOffset(utcOffset + delta);
                ...
                var dday_tzinfo_daylight = new DDay.iCal.TimeZoneInfo();
                ...
                dday_tzinfo_daylight.TZOffsetFrom = new DDay.iCal.UTCOffset(utcOffset);
                dday_tzinfo_daylight.TZOffsetTo = new DDay.iCal.UTCOffset(utcOffset + delta);
        ...
        private ITZID m_TZID;
        private iCalDateTime m_Last_Modified;
        private IURI m_TZUrl;
        private IList<ITimeZoneInfo> m_TimeZoneInfos = new List<ITimeZoneInfo>();
        ...
        {
            if (child is ITimeZoneInfo)
                TimeZoneInfos.Add((ITimeZoneInfo)child);
        ...
        {
            if (child is ITimeZoneInfo && TimeZoneInfos.Contains((ITimeZoneInfo)child))
                TimeZoneInfos.Remove((ITimeZoneInfo)child);
        ...
        public IList<TimeZoneInfo> TimeZoneInfos
        {
        ...
        /// <summary>
        /// Retrieves the ITimeZoneInfo object that contains information
        /// about the TimeZone, with the name of the current timezone,
        /// offset from UTC, etc.
        /// </summary>
        /// <param name="dt">The iCalDateTime object for which to retrieve the ITimeZoneInfo.</param>
        /// <returns>A TimeZoneInfo object for the specified iCalDateTime</returns>
        public ITimeZoneInfo GetTimeZoneInfo(iCalDateTime dt)
        {
            ...
            foreach (ITimeZoneInfo curr in TimeZoneInfos)
            {
                ...
                foreach (IPeriod p in curr.Periods)
                {
