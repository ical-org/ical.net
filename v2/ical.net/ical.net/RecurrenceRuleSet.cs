...
namespace ical.net
{
    internal class RecurrenceRuleSet
    {
        //Expressible notions:
...
//  ==> (1997 EDT)August 5,17,19,31
        ...
        public Duration Interval { get; private set; }

        public RecurrenceRuleSet(int count, Duration interval)
        {
            if (count <= 0)
            {
        ...
        public RecurrenceRuleSet(int count, TimeSpan interval) : this(count, Duration.FromTimeSpan(interval)) {}
    }
}
