...
END:VCALENDAR";
        ...
        var occurrences = calendar.GetOccurrences(date).TakeBefore(date.AddDays(1)).ToList();
    ...
    public void GetOccurrencesWithRecurrenceIdShouldEnumerate()
    {
        ...
        var occurrences = collection.GetOccurrences<CalendarEvent>(startCheck).TakeBefore(startCheck.AddMonths(1)).ToList();
        ...
        var occurrences2 = collection.GetOccurrences<CalendarEvent>(new CalDateTime(startCheck)).TakeBefore(new CalDateTime("20161128T002000", "W. Europe Standard Time"))
            .ToList();
    ...
    public void GetOccurrencesWithRecurrenceId_DateOnly_ShouldEnumerate()
    {
        ...
        var occurrences = collection.GetOccurrences<CalendarEvent>(startCheck).TakeBefore(startCheck.AddMonths(1))
            .ToList();

        var occurrences2 = collection.GetOccurrences<CalendarEvent>(new CalDateTime(startCheck)).TakeBefore(new CalDateTime(2023, 12, 31))
            .ToList();
