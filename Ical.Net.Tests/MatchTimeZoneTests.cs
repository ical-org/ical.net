...
public class MatchTimeZoneTests
{
    ...
    public void MatchTimeZone_LocalTimeUsaWithTimeZone()
    {
        ...
        var occurrences = evt.GetOccurrences(new CalDateTime(2023, 11, 01)).TakeBefore(new CalDateTime(2023, 11, 06));
    ...
    public void MatchTimeZone_LocalTimeAustraliaWithTimeZone(string inputUntil, int expectedOccurrences)
    {
        ...
        var occurrences = evt.GetOccurrences(new CalDateTime(2024, 10, 01)).TakeBefore(new CalDateTime(2024, 10, 07));
