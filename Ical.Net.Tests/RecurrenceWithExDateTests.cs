...
public class RecurrenceWithExDateTests
{
            ...
            Assert.That(
                occurrences.All(
                    o => !cal
                        .Events[0]
                        .ExceptionDates[0]
                        .Any(ex => ex.StartTime.Equals(o.Period.StartTime))), Is.True);
    ...
    public void MultipleExclusionDatesSameTimeZoneShouldBeExcluded()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(cal.Events[0].ExceptionDates[0], Has.Count.EqualTo(3));
            Assert.That(
                occurrences.All(
                    o => !cal
                        .Events[0]
    ...
    public void MultipleExclusionDatesDifferentZoneShouldBeExcluded()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(cal.Events[0].ExceptionDates[0], Has.Count.EqualTo(1));
            Assert.That(cal.Events[0].ExceptionDates[1], Has.Count.EqualTo(1));
            Assert.That(
                occurrences.All(
                    o => !cal
                        .Events[0].
